        ...
        >
            <div className="relative aspect-square overflow-hidden">
                <Image
                    ...
                    width={400}
                    height={400}
                    className="w-full h-full object-cover p-4 transition-all duration-300 group-hover:p-2"
                />
            ...
            <div className="p-3.5 text-zinc-700">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1 truncate">
                        ...
                        <span className="text-sm block text-app-text-light">
                            /{product.unit}
                        </span>
                        {product.originalPrice > product.price && 
                            <span className="line-through text-xs ml-1.5 text-app-text-light">{currency}{product.originalPrice.toFixed(1)}</span>
                        }
                    </div>
